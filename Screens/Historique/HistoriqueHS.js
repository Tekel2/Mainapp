            ...
            <TouchableOpacity 
              ...
              //   onPress={() => navigation.navigate('His_reparation_dtl')}
                onPress ={()=> {
                    ...
                    navigation.navigate('His_hs_dtl',{dataItem:item})
                  }}
                >
                  ...
                  <View style={{flex: 5, backgroundColor:'#316094',borderRadius:5, paddingLeft: 10, }}>
                    ...
                    <Text style={{fontSize: 15, color:'#E4E4E4', fontWeight:'500'}}>Item : {item.item_hs} </Text>
                    <Text style={{fontSize: 15, color:'#E4E4E4', fontWeight:'500'}}>Depuis le : {FormatDate(item.createdOn)}</Text>
                   </View>
    ...
    return (
        ...
        <View style={{ flexDirection:'row',}}>
          <View style={{flex:1, alignContent:'flex-end'}}>
            ...
            Historique Moteurs Hors Service </Text>
          </View>
        </View>
