              ...
              //   onPress={() => navigation.navigate('His_reparation_dtl')}
                ...
                >
                  ...
                  <View style={{flex: 5, backgroundColor:'#316094',borderRadius:5, paddingLeft: 10, }}>
                    <Text style={{fontSize: 20, color:'#E4E4E4', fontWeight:'800'}}>Moteur : {item.moteur_hs.moteur.item_moteur} </Text>
                    {/* <Text style={{fontSize: 15, color:'#E4E4E4', fontWeight:'500'}}>Item : {item.item_preventive} </Text> */}
                    <Text style={{fontSize: 15, color:'#E4E4E4', fontWeight:'500'}}>Date : {FormatDate(item.createdOn)}</Text>
                   </View>
    ...
    return (
        ...
        <View style={{ flexDirection:'row',}}>
          <View style={{flex:1, alignContent:'flex-end'}}>
            ...
            Historique des Réparations </Text>
          </View>
        </View>
